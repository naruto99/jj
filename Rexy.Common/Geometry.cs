...
namespace LeagueSharp.Common
{
    ...
    public static class Geometry
    {
        ...
        /// <param name="squared">if set to <c>true</c> [squared].</param>
        /// <returns></returns>
        public static float LSDistance3D(this Obj_AI_Base unit, Obj_AI_Base anotherUnit, bool squared = false)
        {
            return squared
        ...
        /// <param name="distance">The distance.</param>
        /// <returns></returns>
        public static Vector2 LSShorten(this Vector2 v, Vector2 to, float distance)
        {
            return v - distance * (to - v).LSNormalized();
        }
        ...
        /// <returns></returns>
        public static float LSPolar(this Vector2 v1)
        {
            if (LSClose(v1.X, 0, 0))
            {
                if (v1.Y > 0)
        ...
        {
            var theta = p1.LSPolar() - p2.LSPolar();
            if (theta < 0)
            {
                theta = theta + 360;
            }
        ...
        /// <returns></returns>
        public static Vector2 LSClosest(this Vector2 v, List<Vector2> vList)
        {
        ...
        /// <returns></returns>
        public static object[] LSVectorMovementCollision(Vector2 startPoint1,
            Vector2 endPoint1,
            float v1,
            Vector2 startPoint2,
            float v2,
        ...
        /// <returns></returns>
        public static Vector2[] LSCircleCircleIntersection(Vector2 center1, Vector2 center2, float radius1, float radius2)
        {
        ...
        /// <returns></returns>
        public static bool LSClose(float a, float b, float eps)
        {
        ...
        /// <param name="angle">The angle.</param>
        /// <returns></returns>
        public static Polygon LSRotatePolygon(this Polygon polygon, Vector2 around, float angle)
        {
            var p = new Polygon();
        ...
        /// <returns></returns>
        public static Polygon LSRotatePolygon(this Polygon polygon, Vector2 around, Vector2 direction)
        {
            var deltaX = around.X - direction.X;
            var deltaY = around.Y - direction.Y;
            var angle = (float) Math.Atan2(deltaY, deltaX);
            return LSRotatePolygon(polygon, around, angle - DegreeToRadian(90));
        }
        ...
        /// <returns></returns>
        public static Vector2 LSCenterOfPolygone(this Polygon p)
        {
            var cX = 0f;
            var cY = 0f;
        ...
        /// <returns></returns>
        public static List<Polygon> LSJoinPolygons(this List<Polygon> sList)
        {
            var p = LSClipPolygons(sList);
        ...
        /// <returns></returns>
        public static List<Polygon> LSJoinPolygons(this List<Polygon> sList, ClipType cType,
        ...
        /// <param name="v">The v.</param>
        /// <returns></returns>
        public static List<Polygon> LSToPolygons(this List<List<IntPoint>> v)
        {
            return v.Select(path => path.LSToPolygon()).ToList();
        }
        ...
        /// <param name="delay">The delay.</param>
        /// <returns></returns>
        public static Vector2 LSPositionAfter(this List<Vector2> self, int t, int s, int delay = 0)
        {
        ...
        /// <returns></returns>
        public static Polygon LSToPolygon(this List<IntPoint> v)
        {
        ...
        /// <returns></returns>
        public static List<List<IntPoint>> LSClipPolygons(List<Polygon> polygons)
        {
        ...
        public class Polygon
        {
            ...
            public class Rectangle : Polygon
            {
                ...
                ///     The perpendicular.
                /// </value>
                public Vector2 LSPerpendicular
                {
                    get { return LSDirection.LSPerpendicular(); }
                }
                ...
                public void UpdatePolygon(int offset = 0, float overrideWidth = -1)
                {
                    Points.Clear();
                    Points.Add(
                        Start + (overrideWidth > 0 ? overrideWidth : Width + offset) * LSPerpendicular - offset * LSDirection);
                    Points.Add(
                        Start - (overrideWidth > 0 ? overrideWidth : Width + offset) * LSPerpendicular - offset * LSDirection);
                    Points.Add(
                        End - (overrideWidth > 0 ? overrideWidth : Width + offset) * LSPerpendicular + offset * LSDirection);
                    Points.Add(
                        End + (overrideWidth > 0 ? overrideWidth : Width + offset) * LSPerpendicular + offset * LSDirection);
                }
            }
