...
namespace LeagueSharp.Common
{
    ...
    public static class Geometry
    {
        ...
        {
            return unit.ServerPosition.LSTo2D().Distance(anotherUnit.ServerPosition.LSTo2D(), squared);
        }
        ...
        {
            return unit.ServerPosition.LSTo2D().Distance(anotherUnit.Position.LSTo2D(), squared);
        }
        ...
        {
            return unit.ServerPosition.LSTo2D().Distance(point.LSTo2D(), squared);
        }
        ...
        {
            return unit.ServerPosition.LSTo2D().Distance(point, squared);
        }
        ...
        {
            return v.LSTo2D().Distance(other, squared);
        }
        ...
        {
            return v.Distance(to.LSTo2D(), squared);
        }
        ...
        {
            return v.Distance(to.ServerPosition.LSTo2D(), squared);
        }
