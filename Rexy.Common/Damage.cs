...
namespace LeagueSharp.Common
{
    ...
    public static class Damage
    {
                    ...
                    (source, target) =>
                        ((float)
                            source.CalcDamage(
                                ...
                                new[] {0.15f, 0.20f, 0.25f}[Math.Min(2, (source.Level - 1)/5)]))
            };
            AttackPassives.Add(p);
                    ...
                    (source, target) =>
                        (float)
                            source.CalcDamage(
                                target,
                                DamageType.Physical,
                                (Item.HasItem(ItemId.Infinity_Edge, source) ? 0.875 : 0.5)
                                *(source.TotalAttackDamage
                                  *(1
	    ...
	    */
                ...
                GetDamage =
                    (source, target) =>
                        source.CalcDamage(
                            target,
                            DamageType.Physical,
                            (Item.HasItem(ItemId.Infinity_Edge, source) ? 1.25 : 0.8)*source.TotalAttackDamage)
            };
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                + new[] {1.3, 1.4, 1.5, 1.6, 1.7}[level]*(source.TotalAttackDamage)
                    },
                    //E
                    new DamageSpell
                    {
                            ...
                            if (target is Obj_AI_Minion)
                            {
                                return
                                    Math.Min(
                                        ...
                                        Math.Max(
                                            new double[] {80, 130, 180, 230, 280}[level],
                                            new[] {15, 17.5, 20, 22.5, 25}[level]/100
                                            *target.Health));
                            }
                            return Math.Max(
                                new double[] {80, 130, 180, 230, 280}[level],
                ...
                new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] {80, 125, 170, 215, 260}[level]
                                + new[] {0.4, 0.6, 0.8, 1, 1.2}[level]*source.FlatPhysicalDamageMod
                    },
                    //W
                    new DamageSpell
                    {
                ...
                new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] {50, 75, 100, 125, 150}[level]
                                + new[] {0.3, 0.35, 0.4, 0.45, 0.5}[level]*source.FlatPhysicalDamageMod
                                + 0.6*source.TotalMagicalDamage
                    },
                    //W
                    new DamageSpell
            ...
            Spells.Add(
                ...
                new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new[] {60, 77.5, 95, 112.5, 130}[level]
                                + 0.4*source.TotalMagicalDamage
                    },
                    //Q - cat
                    new DamageSpell
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] {60, 85, 110, 135, 160}[level]
                                + 0.55*source.TotalMagicalDamage
                                + new[] {2, 2.5, 3, 3.5, 4}[level]/100*source.MaxMana
                    },
                    //W
                    new DamageSpell
                    {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) => target is Obj_AI_Minion
                                ...
                                : (new[] {0.20, 0.23, 0.26, 0.29, 0.32}[level]
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                + new[] {0.5, 0.65, 0.8, 0.95, 1.10}[level]
            ...
            Spells.Add(
                ...
                new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                Math.Max(new double[] {40, 60, 80, 100, 120}[level],
        ...
        {
            var crit = Item.HasItem(ItemId.Infinity_Edge, hero) ? 1.5f : 1;
