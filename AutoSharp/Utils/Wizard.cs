...
namespace AutoSharp.Utils
{
    internal static class Extensions
    {
        ...
        public static Vector3 RandomizePosition(this GameObject o)
        {
            ...
            var r = new Random(Environment.TickCount);
            var minRandBy = Program.RandomizerMinRand;
            var maxRandBy = Program.RandomizerMaxRand;
            if (Program.PlayDefensive && Heroes.Player.LSCountEnemiesInRange(800) >= Heroes.Player.CountAlliesInRange(800))
            {
        ...
        {
            menu.AddStringList("autosharp." + ObjectManager.Player.ChampionName + "." + name,displayName,list,0);
        }
        ...
        {
            menu.Add("autosharp." + ObjectManager.Player.ChampionName + "." + name,
                new Slider(displayName, value, min, max));
        }

        public static void AddObject(this Menu menu, string name, string displayName, bool value)
        {
            menu.Add("autosharp." + ObjectManager.Player.ChampionName + "." + name, new CheckBox(displayName, value));
        }
    }
