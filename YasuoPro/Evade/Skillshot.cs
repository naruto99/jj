...
namespace Evade
{
    ...
    public class Skillshot
    {
        ...
        /// </summary>
        public bool GetValue<T>(string name)
        {
            return YasuoMenu.Config[name + SpellData.MenuItemName].Cast<CheckBox>().CurrentValue;
        }

        /// <summary>
        ///     Returns the value from this skillshot menu.
        /// </summary>
        public int GetValueSl<T>(string name)
        {
            return YasuoMenu.Config[name + SpellData.MenuItemName].Cast<Slider>().CurrentValue;
        }
        ...
        public bool Evade()
        {
            ...
            if (!GetValue<bool>("IsDangerous") && YasuoMenu.Config["Evade.OnlyDangerous"].Cast<KeyBind>().CurrentValue)
            {
                _cachedValue = false;
        ...
        public bool Evade(SpellSlot slot)
        {
            ...
            if (!GetValue<bool>("IsDangerous") && YasuoMenu.Config["Evade.OnlyDangerous"].Cast<CheckBox>().CurrentValue)
            {
                _cachedValue = false;
                _cachedValueTick = Utils.TickCount;
                return _cachedValue;
