...
namespace Evade
{
    internal static class Config
    {
        ...
        {
            Menu = new Menu("Evade", "Evade", false);
            ...
            foreach (var hero in ObjectManager.Get<AIHeroClient>())
            {
                if (hero.Team != ObjectManager.Player.Team || TestOnAllies)
                {
                    ...
                    {
                        if (string.Equals(spell.ChampionName, hero.ChampionName,
                            StringComparison.InvariantCultureIgnoreCase))
                        {
                            ...
                            subMenu.AddItem(
                                new MenuItem("Enabled" + spell.MenuItemName, "Enabled").SetValue(
            ...
            misc.AddItem(
                new MenuItem("BlockSpells", "Block spells while evading").SetValue(
            ...
            Menu.AddItem(
                new MenuItem("Enabled", "Enabled").SetValue(new KeyBind("K".ToCharArray()[0], KeyBindType.Toggle, false)));
