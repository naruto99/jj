    ...
    public static class Geometry
    {
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = LeagueSharp.Common.Geometry.LSCircleCircleIntersection(Start, End, innerRadius,
                    innerRadius);
                var outerCenters = LeagueSharp.Common.Geometry.LSCircleCircleIntersection(Start, End, outerRadius,
                    outerRadius);
