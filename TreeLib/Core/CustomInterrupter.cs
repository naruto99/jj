...
namespace TreeLib.Core
{
    ...
    {
        /// <summary>
        ///     The delegate for <see cref="CustomInterrupter.OnInterruptableTarget" />.
        /// </summary>
        ...
        private static void InitializeSpells()
        {
            ...
            foreach (var spellList in InterruptableSpells)
            {
        ...
        /// <summary>
        ///     Prevents event arguments for the <see cref="CustomInterrupter.OnInterruptableTarget" />
        /// </summary>
