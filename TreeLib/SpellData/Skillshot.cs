...
namespace TreeLib.SpellData
{
    ...
    public class Skillshot
    {
        ...
        public int DangerLevel
        {
            ...
            {
                return
                    Config.Menu.AddSubMenu(SpellData.ChampionName.ToLowerInvariant())
                        .AddSubMenu(SpellData.SpellName)
                        ["DangerLevel"]
                        .Cast<EloBuddy.SDK.Menu.Values.Slider>()
                        .CurrentValue;
            }
        }
        ...
        public bool Enable
        {
            get
            {
                ...
                if (
                    !Config.Menu[SpellData.ChampionName.ToLowerInvariant()]
                        .Cast<CheckBox>().CurrentValue
                        &&
                    Config.Menu["OnlyDangerous"].Cast<EloBuddy.SDK.Menu.Values.KeyBind>().CurrentValue)
                {
                    cachedValue = false;
                ...
                cachedValue =
                    Config.Menu[SpellData.ChampionName.ToLowerInvariant()].Cast<CheckBox>().CurrentValue;
                cachedValueTick = Utils.GameTimeTickCount;
                return cachedValue;
            }
        }
