        ...
        static SpellDatabase()
        {
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    CollisionObjects =
                        new[]
                        {CollisionObjectTypes.Champion, CollisionObjectTypes.Minion, CollisionObjectTypes.YasuoWall}
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    CollisionObjects =
                        new[]
                        {CollisionObjectTypes.Champion, CollisionObjectTypes.YasuoWall, CollisionObjectTypes.Minion}
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    CollisionObjects =
                        new[]
                        {CollisionObjectTypes.Minion, CollisionObjectTypes.Champion, CollisionObjectTypes.YasuoWall}
                });
            ...
            Spells.RemoveAll(
                i =>
                    !HeroManager.Enemies.Any(
                        a => string.Equals(a.ChampionName, i.ChampionName, StringComparison.InvariantCultureIgnoreCase)));
        }
        ...
        public static SpellData GetByMissileName(string missileSpellName)
        {
            ...
            return
                Spells.FirstOrDefault(
                    i =>
                        i.MissileSpellName != null && i.MissileSpellName.ToLower() == missileSpellName ||
                        i.ExtraMissileNames.Contains(missileSpellName));
        }
